...
Page.nav(ManufacturingInformationReport).verifyUICommonVisible()
										.verifyMachinesVisible("Set-up", "3-axis milling machine [small]")
										.verifyMachinesVisible("Programming time", "3-axis milling machine [small]")
										.verifyMachinesVisible("Processing time", "3-axis milling machine [small]")
										.verifyMachinesVisible("Processing time", "In between tempering cost")
