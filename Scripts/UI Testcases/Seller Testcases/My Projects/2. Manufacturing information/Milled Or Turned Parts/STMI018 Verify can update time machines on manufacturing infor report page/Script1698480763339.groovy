...
Page.nav(ManufacturingInformationReport).clickEdit()
										.inputSetupSaw(setupSaw)
										.inputSetupInterimDeburring(setupInterimDeburring)
										.inputSetup3AxisMillingMachine(setup3AxisMillingMachine)	
										.inputSetupRoundingMachine(setupRoundingMachine)
										.inputProgramming3AxisMillingMachine(programming3AxisMillingMachine)										
										.inputProcessSaw(processSaw)
										.inputProcessInterimDeburring(processInterimDeburring)
										.inputProcess3AxisMillingMachine(process3AxisMillingMachine)
										.inputProcessRoundingMachine(processRoundingMachine)
										.clickSave()										

Page.nav(ManufacturingInformationReport).verifyTimeMachines("Set-up", "Saw", setupSaw)
										.verifyTimeMachines("Set-up", "Interim deburring", setupInterimDeburring)
										.verifyTimeMachines("Set-up", "3 -axis milling machine [medium]", setup3AxisMillingMachine)
										.verifyTimeMachines("Set-up", "Rounding machine [medium]", setupRoundingMachine)
										.verifyTimeMachines("Programming time", "3 -axis milling machine [medium]", programming3AxisMillingMachine)
										.verifyTimeMachines("Processing time", "Saw", processSaw)
										.verifyTimeMachines("Processing time", "Interim deburring", processInterimDeburring)
										.verifyTimeMachines("Processing time", "3 -axis milling machine [medium]", process3AxisMillingMachine)
										.verifyTimeMachines("Processing time", "Rounding machine [medium]", processRoundingMachine)
										.clickCancel()
