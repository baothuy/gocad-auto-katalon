...
Page.nav(AccountSettingsPage).verifyFirstNameBillingAddressValue(billingAddressChanged[0])
								...
								.verifyStreetShippingAddressValue(shippingAddressChanged[5])
								.verifyHouseNumberShippingAddressValue(shippingAddressChanged[4])								
...
Page.nav(AccountSettingsPage).inputFirstNameBillingAddress(billingAddress[0])
								...
								.inputSearchShippingAddress(shippingAddress[4], shippingAddress[5], shippingAddress[8], shippingAddress[9], shippingAddress[6])
								.clickSaveChangesButton()
								.verifyToastMessageWhenSaveChange()
								.sleep(1)