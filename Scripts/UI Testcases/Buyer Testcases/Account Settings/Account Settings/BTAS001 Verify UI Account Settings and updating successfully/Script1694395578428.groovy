...
Page.nav(AccountSettingsPage).inputFirstNameBillingAddress(billingAddress[0])
								...
								.inputStreetBillingAddress(billingAddress[4])
								.inputHouseNumberBillingAddress(billingAddress[5])
								.selectCountryBillingAddress(billingAddress[6])
								.selectStateBillingAddress(billingAddress[7])								
								.selectCityBillingAddress(billingAddress[8])
								.inputZIPCodeBillingAddress(billingAddress[9])
								...
								.inputStreetShippingAddress(shippingAddress[4])
								.inputHouseNumberShippingAddress(shippingAddress[5])								
								.selectCountryShippingAddress(shippingAddress[6])
								.selectStateShippingAddress(shippingAddress[7])								
								.selectCityShippingAddress(shippingAddress[8])	
								.inputZIPCodeShippingAddress(shippingAddress[9])
								.clickSaveChangesButton()
								.verifyToastMessageWhenSaveChange()
								.sleep(1)